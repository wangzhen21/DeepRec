...
class NeuMF():
    def __init__(self, args, num_users, num_items,batch_size=128,
        ...
        print("MF.")
    def GMF_build_core_model(self, user_indices,item_indices):
    ...
    def build_core_model(self, user_indices, item_indices):
        vector_GMF, len_GMF, params_GMF = self.GMF_build_core_model(user_indices, item_indices)
        vector_MLP, len_MLP, params_MLP = self.MLP_build_core_model(user_indices, item_indices)

...
def fin_fout_file(filein,fileout):
    ...
    with open(filein,'r') as fin:
        for line in tqdm.tqdm(fin):
            ...
            outfile(fileout,line_split[0] + '\t' + line_split[1] + '\t' + line_split[2] + '\t' + line_split[0] + ":3")
...
fin_fout_file("data/ml1m/train_1m_ratings.dat.nfm","data/ml1m_nfm/nfm_train_1m_ratings.dat.test")
fin_fout_file("data/ml1m/test_1m_ratings.dat.nfm","data/ml1m_nfm/nfm_test_1m_ratings.dat.test")
...
class LoadData(object):
    ...
    def __init__(self, path, dataset, loss_type):
        ...
        self.trainfile = self.path + "nfm_train_1m_ratings.dat"
        self.testfile = self.path + "nfm_test_1m_ratings.dat"
        self.validationfile = self.path + "nfm_test_1m_ratings.dat"
...
class LoadData_cut_dire(object):
    '''given the path of data, return the data format for DeepFM
    :param path
    return:
    Train_data: a dictionary, 'Y' refers to a list of y values; 'X' refers to a list of features_M dimension vectors with 0 or 1 entries
    ...
    def __init__(self, path, dataset, loss_type):
        self.path = path + dataset + "/"
        self.trainfile = self.path + "nfm_train_1m_ratings.dat.cut_dire"
        self.testfile = self.path + "nfm_test_1m_ratings.dat.cut_dire"
        self.validationfile = self.path + "nfm_test_1m_ratings.dat.cut_dire"
        self.features_M = self.map_features()
        self.Train_data, self.Validation_data, self.Test_data = self.construct_data(loss_type)

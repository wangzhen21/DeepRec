...
from models.rating_prediction.NeuMF import NeuMF
...
def parse_args():
    ...
    parser.add_argument('--model', choices=['MF', 'NNMF', 'NRR', 'I-AutoRec', 'U-AutoRec', 'FM', 'NFM', 'AFM','NeuMF'], default='NeuMF')
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        ...
        if args.model == "NeuMF":
            ...
            model = NeuMF(args1, n_user, n_item)
        if args.model == "MF":
